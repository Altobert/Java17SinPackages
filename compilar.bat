...
rem Compilando
javac -d classes packagea/*.java packageb/*.java packagec/*.java algoritmos/*.java structure/*.java swanexample/*.java teststring/*.java varsample/*.java multiplevariables/*.java
